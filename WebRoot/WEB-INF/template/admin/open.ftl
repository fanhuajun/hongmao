...
$(document).on('click','.form_ok1',function(){
       ...
       var name = $("#name").val();
       var phone = $("#phone").val();
       var end = $("#datetime11").val();
       var agentid = $("#agentid").val();
       var money = timechange("money");
