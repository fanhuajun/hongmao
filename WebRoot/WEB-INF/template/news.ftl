...
<body class="header-padd">
	<div class="content">
		...
		<dl class="seller-tj">
			...
			<dd>
				<div class="tj-img">
					<img src="${news.pic}"> <!-- 680*290 -->
				</div>
				<p class="tem-detail">${(news.createdate?number_to_datetime?string("yyyy-MM-dd "))!}发布</p>
				<p class="tem-detail">${news.content}</p>
			</dd>
			</#list>
		</dl>
	</div>
