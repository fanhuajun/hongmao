...
<body class="header-padd">
	<div class="content">
		...
		<div class="tx-box">
			<p class="tx-total">可提现金额&nbsp;:&nbsp;<span>&yen;${limit!}</span><a href="deposit!details.action">提现明细</a></p>
			...
			<div class="tx-group">
				<div class="tx-g-list">
					...
					<div class="tx-container">
						<input data-limit="${limit}" id="total" type='text' class="tx-g-ipt" value="${limit}" placeholder="请填写提现金额" disabled="disabled" />
					</div>
				</div>
				<div class="tx-g-list">
					<span class="txtit">真实姓名&nbsp;:&nbsp;</span>
					<div class="tx-container">
						<input name="name" type='text' class="tx-g-ipt" placeholder="请填写真实姓名">
					</div>
				</div>
				...
				<div class="tx-g-list wx"  >
					...
					<div class="tx-container">
						<input type='text' name="wxname" class="tx-g-ipt" placeholder="请填写微信号">
					</div>
				</div>
