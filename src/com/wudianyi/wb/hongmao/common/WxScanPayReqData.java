...
import com.wudianyi.wb.hongmao.util.RandomStringGenerator;
...
public class WxScanPayReqData {
	 ...
	 */
	public WxScanPayReqData(String appid, String attach, String body,
			String mchid, String notify_url, String outTradeNo,
			String productId, String spBillCreateIP, int totalFee, String key) {
