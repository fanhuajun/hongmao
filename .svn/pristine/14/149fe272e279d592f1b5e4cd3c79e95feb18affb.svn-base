<#include "/WEB-INF/template/admin/header.ftl" />
	...
	<div class="zxbody">
		...
		<form id="myform" name="myform" method="post" action="json/user!update.action?${user.id}">
			<div class="zxform">
				<table cellspacing="0" cellpadding="0" width="100%" class="zxtable">
						...
						<td>
							<table cellspacing="0" cellpadding="0" width="100%" class="form_table">
								<tr>
									<td class="imgtd">
										<div class="">
											<img class="" alt="" id="" src="${(user.pic)!}@40h_40w" />
										</div>
									</td>
								</tr>
							</table>
					...
					<tr  class="tt-0">
						...
						<td><input class="dia_inp" ms-duplex-required="a" type="text" placeholder=" " id="bn" name="bn" value="${user.name}"  readonly="readonly" ></td>
					</tr>
					
					<tr  class="tt-0">
						<td class="zxltd">手机号：</td>
						<td><input class="dia_inp" type="text" placeholder=" " id="bn" name="bn" value="${user.phone}"  readonly="readonly"></td>
					</tr>
					
					<tr  class="tt-0">
						<td class="zxltd">微信号：</td>
						<td><input class="dia_inp" type="text" placeholder=" " id="bn" name="bn" value="<#if user.weixinnum??>${user.weixinnum}<#else>---</#if>"  readonly="readonly"></td>
					</tr>
					
					<tr  class="tt-0">
						<td class="zxltd">性  别：</td>
						<td><input class="dia_inp" type="text" placeholder=" " id="bn" name="bn" value="<#if user.sex??> <#if user.sex==0>女<#else>男</#if> <#else>男</#if>"  readonly="readonly"></td>
					</tr>
					
					<tr  class="tt-0">
						<td class="zxltd">电子邮箱：</td>
						<td><input class="dia_inp" type="text" placeholder=" " id="bn" name="bn" value="<#if user.email??>${user.email}<#else>---</#if>"  readonly="readonly"></td>
					</tr>
