<#include "/WEB-INF/template/admin/header.ftl" />
	...
	<div class="zxbody">
		<div class="zxbody_title zxbody_title2">
			<a href="agent!list.action" class="zxback">
...
$(document).on('click','.form_ok1',function(){
       ...
       $.ajax({
           url:'json/agent!save.action',
           type:'post',
           dataType:'json',
           data:{username:username,pwd:pwd,name:name,agentid:agentid},
