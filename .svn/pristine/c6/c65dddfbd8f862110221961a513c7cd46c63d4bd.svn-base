...
<style>
.dia_text2{width:240px;height:120px;}
</style>
...
<div class="hide_id">
	...
	<!-- 删除 -->
	<input id="delcategory" type="hidden" value="">
	
	<!-- 用于点击新增、修改时候，存放点击对应的nodeId -->
	<input id="thisId" name="thisId" type="hidden" value="">
	<input id="thisEle" name="thisEle" type="hidden" value="">
	...
	<div class="dialog_body">
		...
		<div class="dialog_right">
			<table cellspacing="0" cellpadding="0" width="100%" class="dia_table">
				<tr>
					<td class="dia_ltd"><span class="must"></span>文章名称</td> 
					<td><input type="text" class="dia_inp" id="addName2"></td>
				</tr>
				<tr>
					<td class="dia_ltd">栏目描述</td>
					<td><textarea placeholder="" class="dia_text dia_text2" id="addInfo"></textarea></td>
				</tr>
				
			    <tr>
					<td class="dia_ltd">是否在主页显示</td>
					<td><input name="toindex" id="toindex" type="checkbox" checked=""  /></td>
...
<div class="dialog dialog_add">
	...
	<div class="dialog_body">
		...
		<div class="dialog_right" >
			<table cellspacing="0" cellpadding="0" width="100%" class="dia_table" >
				<tr>
					<td class="dia_ltd"><span class="must">*</span><b1>文章名称</b1></td> 
					<td><input placeholder="请输入城市名称" type="text" class="dia_inp" id="addName"></td>
				</tr>
				<tr>
					<td class="dia_ltd">排序</td>
					<td><input placeholder="数字越大越靠前" type="text" class="dia_inp" id="addRank1" ></td>
				</tr>
			</table>
		</div>
	</div>
