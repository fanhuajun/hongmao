...
public class BaseAction extends ActionSupport {
	...
	public String getTick() throws Exception {
		Shop shop = getFrontShop();
		return wxmenuService.getTicket(shop.getAppid(), shop.getAppKey());
	}

	public Shop getFrontShop() {
		return shopService.get(getFrontShopid());
	}

	public Integer getFrontShopid() {
		if (getParameter("uu") != null) {
			return Integer.parseInt(getParameter("uu"));
		} else {
			return (Integer) getSession(Const.SESSION_FRONT_SHOPID);
		}
	}
	...
	public Integer getSession_customer_id() {
		Object useridObj = getSession(Const.SESSION_USER_ID);
		if (useridObj != null) {
	...
	public Integer getSession_is_admin() {
		Object isadminObj = getSession(Const.SESSION_ADMIN_ADMIN);
		if (isadminObj != null) {
			return (Integer) isadminObj;
		}
		return 0;
	}
