...
<body class="header-padd">
	<div class="content">
		<header class="default-head">
			...
			<div class="head-tit">${shopcategoryname}</div>
		...
		<#if list??&&(list?size gt 0)>
			...
			<dd>
				<div class="tj-img">
					<img src="${item.pic}"> <!-- 680*290 -->
				</div>
				<p class="tj-mess1"><span class="tj-tit1">菜名&nbsp;:&nbsp;</span>${item.title}</p>
				<p class="tj-mess1"><span class="tj-tit1">价格&nbsp;:&nbsp;</span>&yen;88.00</p>
				<p class="tj-mess1"><span class="tj-tit1">介绍&nbsp;:&nbsp;</span>${item.content}</p>
			</dd>
			</#list>
		 </#if>
		</dl>
