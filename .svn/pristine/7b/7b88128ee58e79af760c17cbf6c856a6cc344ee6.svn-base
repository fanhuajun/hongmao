...
<script src="${base}/static/admin/js/jquery.page-noajax.js"></script>
	...
	<div class="zxbody" style="position:relative;">
			...
			<!--<div class="extend_tab">
				...
				<span  class="stat_tab" data-stat="1" >一级返佣</span>
				<span  class="stat_tab" data-stat="2">二级返佣</span>
				<span  class="stat_tab" data-stat="3">三级返佣</span>
			</div>-->
			<br>
...
function getContentList(pn,stat){
	var url = "json/rebate!list.action";
    if(pn==0){
        pn=1;
    }
	$.ajax({
...
function showPage(pn,stat){
	var url = "json/rebate!totalNum.action";
